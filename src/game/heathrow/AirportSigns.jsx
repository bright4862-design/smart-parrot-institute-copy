...
export const AIRPORT_SIGNS = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'GATE A12  →',
    shortLabel: 'Gate A12',
    position: Object.freeze([-3.8, 4.3, -5.7]),
    interactionPosition: Object.freeze({ x: -3.8, z: -3.65 }),
    width: 4.2,
    fontSize: 0.34,
    cameraSide: 1,
  ...
  Object.freeze({
    ...
    position: Object.freeze([9.5, 4.25, -4.8]),
    interactionPosition: Object.freeze({ x: 9.5, z: -2.75 }),
    width: 4.4,
    fontSize: 0.3,
    cameraSide: -1,

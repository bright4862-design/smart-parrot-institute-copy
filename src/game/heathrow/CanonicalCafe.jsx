...
function MenuBoard({ x, label, price }) {
  return (
    <group position={[x, 3.08, 2.35]}>
      <RoundedBox args={[2.25, 1.15, 0.12]} radius={0.08} castShadow>
        <meshStandardMaterial color="#19372F" roughness={0.58} />
      </RoundedBox>
      <Text position={[0, 0.18, -0.07]} rotation={[0, Math.PI, 0]} material-side={THREE.FrontSide} fontSize={0.19} color="#FFF4D6" anchorX="center" anchorY="middle">
        {label}
      </Text>
      <Text position={[0, -0.2, -0.07]} rotation={[0, Math.PI, 0]} material-side={THREE.FrontSide} fontSize={0.13} color="#BEE5D2" anchorX="center" anchorY="middle">
        {price}
      </Text>
    </group>
  );
  ...
  return (
    <group name={CANONICAL_CAFE_ID} position={[22, 0, 8]}>
      ...
      <group position={[0, 4.15, 0.55]}>
        ...
        <Text position={[0, 0.12, -0.095]} rotation={[0, Math.PI, 0]} material-side={THREE.FrontSide} fontSize={0.44} color="#FFF2CF" anchorX="center" anchorY="middle" outlineWidth={0.01} outlineColor="#12251F">
          TERMINAL CAFÉ
        </Text>
        <Text position={[0, -0.3, -0.095]} rotation={[0, Math.PI, 0]} material-side={THREE.FrontSide} fontSize={0.14} color="#BFE2D2" anchorX="center" anchorY="middle">
          COFFEE · TEA · PASTRIES
        </Text>
      </group>

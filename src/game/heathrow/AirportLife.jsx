...
const CAFE_WORKERS = Object.freeze({
  barista: Object.freeze({
    id: 'cafe-barista',
    position: Object.freeze([19.2, 0.72, 9.35]),
    rotation: Math.PI,
    animation: 'work',
    activity: 'tablet',
    role: 'staff',
  ...
  service: Object.freeze({
    id: 'cafe-service',
    position: Object.freeze([23.1, 0.72, 9.35]),
    rotation: Math.PI,
    animation: 'work',
    activity: 'tray',
    role: 'staff',

...
if (parsed.protocol !== 'https:' || !parsed.hostname.endsWith('.supabase.co')) {
  throw new Error('Preview E2E only accepts an HTTPS Supabase project URL.');
}
...
console.log('Preview readiness gate passed. Provider-write E2E remains intentionally separate and disabled by this probe.');
